...
*/ 
  ...
  /*--------------------------------------:noTabs=true:tabSize=2:indentSize=2:--
    ...
    --
    --  $HeadURL: http://svn.xinha.python-hosting.com/tags/0.91beta/htmlarea.js $
    --  $LastChangedDate: 2007-01-14 21:54:38 +0200 (Sun, 14 Jan 2007) $
...
{
  'Release'   : 'Trunk',
  'Head'      : '$HeadURL: http://svn.xinha.python-hosting.com/tags/0.91beta/htmlarea.js $'.replace(/^[^:]*: (.*) \$$/, '$1'),
  'Date'      : '$LastChangedDate: 2007-01-14 21:54:38 +0200 (Sun, 14 Jan 2007) $'.replace(/^[^:]*: ([0-9-]*) ([0-9:]*) ([+0-9]*) \((.*)\) \$/, '$4 $2 $3'),
  'Revision'  : '$LastChangedRevision: 655 $'.replace(/^[^:]*: (.*) \$$/, '$1'),
